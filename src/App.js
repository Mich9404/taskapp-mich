...
function App() {
  ...
  useEffect(() => {
    ...
    if (data != null) {
      ...
      setUserName('Mich Example');
      setTaskItems([
        {name: 'Task One LS', done: false},
        {name: 'Task Two LS', done: false},
        {name: 'Task Three LS', done: true},
        {name: 'Task Four LS', done: false}
      ]);
  ...
  return (
    <div>
      ...
      <table className="table table-striped table-dordered" >
        <thead>
          <tr>
            <th>Description</th>
            <th>Done</th>
